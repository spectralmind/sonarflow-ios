...
@interface SFDefaultIPhoneHelpView : UIView <SFIPhoneHelpView, UIScrollViewDelegate>
...
@property (nonatomic, weak) IBOutlet UIImageView *help41;
@property (nonatomic, weak) IBOutlet UIView *help42;
